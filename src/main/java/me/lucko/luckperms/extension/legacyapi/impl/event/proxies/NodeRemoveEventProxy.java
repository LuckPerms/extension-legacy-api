...
public class NodeRemoveEventProxy implements NodeRemoveEvent {
    private final LegacyApiProvider api;
    private final net.luckperms.api.event.node.NodeRemoveEvent event;

    public NodeRemoveEventProxy(LegacyApiProvider api, net.luckperms.api.event.node.NodeRemoveEvent event) {
        this.api = api;
        this.event = event;
    }
    ...
    public @NonNull Node getNode() {
        return new NodeProxy(event.getNode());
    }
