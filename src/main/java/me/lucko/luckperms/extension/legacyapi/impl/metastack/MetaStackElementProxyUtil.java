...
public enum MetaStackElementProxyUtil {
    ...
    public static MetaStackElement legacyElement(net.luckperms.api.metastacking.MetaStackElement modern) {
    ...
    public static net.luckperms.api.metastacking.MetaStackElement modernElement(MetaStackElement legacy) {
