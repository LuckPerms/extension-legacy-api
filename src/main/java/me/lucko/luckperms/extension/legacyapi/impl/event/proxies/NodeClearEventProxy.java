...
public class NodeClearEventProxy implements NodeClearEvent {
    private final LegacyApiProvider api;
    private final net.luckperms.api.event.node.NodeClearEvent event;

    public NodeClearEventProxy(LegacyApiProvider api, net.luckperms.api.event.node.NodeClearEvent event) {
        this.api = api;
        this.event = event;
    }
