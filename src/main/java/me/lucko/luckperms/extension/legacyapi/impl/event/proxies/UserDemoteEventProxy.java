...
public class UserDemoteEventProxy implements UserDemoteEvent {
    private final LegacyApiProvider api;
    private final net.luckperms.api.event.user.track.UserDemoteEvent event;

    public UserDemoteEventProxy(LegacyApiProvider api, net.luckperms.api.event.user.track.UserDemoteEvent event) {
        this.api = api;
        this.event = event;
    }
