...
public class NodeAddEventProxy implements NodeAddEvent {
    private final LegacyApiProvider api;
    private final net.luckperms.api.event.node.NodeAddEvent event;

    public NodeAddEventProxy(LegacyApiProvider api, net.luckperms.api.event.node.NodeAddEvent event) {
        this.api = api;
        this.event = event;
    }
